...
export default function AssignedTicket() {
  ...
  const handleAccept  = (id) => { const t = tickets.find(t => t.id === id); if (t) { t.statut = "in_progress"; rerender(); } };
  const handleHold    = (id) => { const t = tickets.find(t => t.id === id); if (t) { t.statut = "pending";     rerender(); } };
  ...
  return (
    <div className="ta">
      ...
      {/* ── Toolbar : recherche + dropdowns uniquement ── */}
      <div className="ta-toolbar">
        ...
        <button className="ta-filter-icon-btn" title="Réinitialiser les filtres"
