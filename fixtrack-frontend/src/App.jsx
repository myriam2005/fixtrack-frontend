...
import GestionMachines from "./pages/admin/GestionMachines";   // ✅ nouveau
            ...
            <PrivateRoute>
              <Layout notifCount={3}>
                <Routes>
                  ...
                  <Route path="manager/machines"           element={<GestionMachines />} /> {/* ✅ manager aussi */}
                  ...
                  <Route path="admin/machines"             element={<GestionMachines />} /> {/* ✅ branché */}
                  ...
                  {/* ── Machines historique (partagé tous rôles) ── */}
                  <Route path="machines/:id/historique"    element={<PlaceholderPage title="Historique Machine" />} /> {/* ✅ cible du bouton */}
