...
export const tickets = [
  ...
  { id:"t44", titre:"Imprimante bloquée — test",           description:"Test.",                                                                                      statut:"assigned",    priorite:"medium",   categorie:"Informatique", localisation:"Bâtiment C — Bureau Scolarité", auteurId:"u1", auteurTel:"+216 55 000 111",technicienId:"u3", dateCreation:"2025-01-13", notes:["Pièce commandée."] },
  { id:"t3",  titre:"Imprimante bloquée — bourrage papier",description:"Bourrage papier impossible à débloquer manuellement.",                                       statut:"in_progress", priorite:"medium",   categorie:"Informatique", localisation:"Bâtiment C — Bureau Scolarité", auteurId:"u1", auteurTel:"+216 55 000 111",technicienId:"u3", dateCreation:"2025-01-13", notes:["Pièce commandée, livraison prévue demain."] },
  { id:"t4",  titre:"Serveur très lent — salle informatique", description:"Le serveur est extrêmement lent, les étudiants ne peuvent pas travailler.", statut:"resolved",    priorite:"high",     categorie:"Informatique", localisation:"Bâtiment A — Salle Informatique",auteurId:"u1", auteurTel:null,             technicienId:"u3", dateCreation:"2025-01-10", notes:["RAM nettoyée, performances revenues à la normale."] },
  ...
  { id:"t6",  titre:"Fuite d'eau au plafond",              description:"Infiltration d'eau visible au plafond des toilettes RDC. Sol glissant, risque de chute.", statut:"open",        priorite:"critical", categorie:"Plomberie",   localisation:"Bâtiment A — Toilettes RDC",     auteurId:"u1", auteurTel:"+216 22 333 444",technicienId:null, dateCreation:"2025-01-16", notes:[] },
  { id:"t7",  titre:"Serrure de porte cassée",             description:"La serrure de la salle de réunion ne ferme plus correctement.",                          statut:"assigned",    priorite:"medium",   categorie:"Sécurité",    localisation:"Bâtiment B — Salle de réunion", auteurId:"u1", auteurTel:null,             technicienId:"u2", dateCreation:"2025-01-15", notes:[] },
  { id:"t8",  titre:"Ampoules grillées — couloir",         description:"Plusieurs ampoules grillées dans le couloir du 2e étage, éclairage insuffisant.",        statut:"in_progress", priorite:"low",      categorie:"Électrique",  localisation:"Bâtiment C — Couloir Étage 2",  auteurId:"u1", auteurTel:null,             technicienId:"u2", dateCreation:"2025-01-12", notes:["Ampoules commandées."] },
];
