...
export const tickets = [
  {
    ...
    description:
      "La climatisation ne fonctionne plus depuis ce matin, température insupportable.",
    statut: "open",
    priorite: "critical",
    categorie: "HVAC",
  ...
  },
  {
    ...
    description:
      "Le projecteur de l'amphi clignote pendant les cours, perturbant étudiants et enseignants.",
    statut: "assigned",
    priorite: "high",
  ...
  },
  {
    ...
    description:
      "Le serveur est extrêmement lent, les étudiants ne peuvent pas travailler.",
    statut: "resolved",
    priorite: "high",
    categorie: "Informatique",
  ...
  },
  {
    ...
    description:
      "Infiltration d'eau visible au plafond des toilettes RDC. Sol glissant, risque de chute.",
    statut: "open",
    priorite: "critical",
    categorie: "Plomberie",
  ...
  },
  {
    ...
    description:
      "Plusieurs ampoules grillées dans le couloir du 2e étage, éclairage insuffisant.",
    statut: "in_progress",
    priorite: "low",
    categorie: "Électrique",
...
//
//  USER       → reçoit notif quand SON ticket change de statut (résolu, fermé, en cours, assigné)
...
export const mockNotifications = [
  // ── USER u1 : son ticket t4 a été résolu ──────────────────────────────
  {
    id: "mn1",
  ...
  // ── USER u1 : son ticket t3 est passé en cours ────────────────────────
  {
    id: "mn2",
  ...
  // ── TECHNICIAN u2 : assigné au ticket t2 ──────────────────────────────────
  {
    id: "mn3",
    message:
      "Vous avez été assigné au ticket 'Projecteur qui scintille en cours' — Amphithéâtre 1.",
    type: "info",
    lu: false,
  ...
  // ── TECHNICIAN u2 : réassigné au ticket t7 ────────────────────────────────
  {
    id: "mn4",
    message:
      "Vous avez été réassigné au ticket 'Serrure de porte cassée' — Bâtiment B.",
    type: "info",
    lu: false,
  ...
  // ── TECHNICIAN u3 : assigné au ticket t3 ──────────────────────────────────
  {
    id: "mn5",
    message:
      "Vous avez été assigné au ticket 'Imprimante bloquée — bourrage papier' — Bureau Scolarité.",
    type: "info",
    lu: false,
  ...
  // ── MANAGER u4 : nouveau ticket créé (t1) ─────────────────────────────────
  {
    id: "mn6",
    message:
      "Nouveau ticket créé : 'Climatisation en panne salle B12' par Jean Dupont.",
    type: "info",
    lu: false,
  ...
  // ── MANAGER u4 : ticket critique t6 ──────────────────────────────────────
  {
    id: "mn7",
    message:
      "Ticket CRITIQUE : 'Fuite d'eau au plafond' — intervention urgente requise.",
    type: "warning",
    lu: false,
  ...
  // ── MANAGER u4 : ticket t4 résolu, validation requise ─────────────────────
  {
    id: "mn8",
    message:
      "Ticket résolu en attente de validation : 'Serveur très lent' — veuillez confirmer.",
    type: "success",
    lu: false,
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    forUserId: "u4",
  ...
  // ── ADMIN u5 : nouveau ticket créé (t6) ───────────────────────────────────
  {
    id: "mn9",
    message:
      "Nouveau ticket créé : 'Fuite d'eau au plafond' par Jean Dupont — priorité CRITIQUE.",
    type: "warning",
    lu: false,
    timestamp: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
    forUserId: "u5",
  ...
  // ── ADMIN u5 : ticket t2 assigné ──────────────────────────────────────────
  {
    id: "mn10",
    message:
      "Ticket assigné : 'Projecteur qui scintille en cours' → Sara Ben Ali.",
    type: "info",
    lu: false,
  ...
  // ── ADMIN u5 : ticket t7 réassigné ────────────────────────────────────────
  {
    id: "mn11",
    message:
      "Ticket réassigné : 'Serrure de porte cassée' → Sara Ben Ali (changement de technicien).",
    type: "info",
    lu: false,
    timestamp: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
    forUserId: "u5",
